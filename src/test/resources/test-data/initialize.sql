...
INSERT INTO usr(id, email, password, name, credentials_updated_at, version)
VALUES (104, 'user@example.com', '{bcrypt}$2a$10$nzg1V.oO8HIgtny2HaaJdObxwZIzz9HvbFP8nW0BfBID4COq8AZMe', 'User', '2000-01-01 12:01:01', 1);

INSERT INTO usr(id, email, password, name, credentials_updated_at, version)
VALUES (105, 'unverifieduser@example.com', '{bcrypt}$2a$10$nzg1V.oO8HIgtny2HaaJdObxwZIzz9HvbFP8nW0BfBID4COq8AZMe', 'Unverified User', '2000-01-01 12:01:01', 1);
INSERT INTO usr_role(user_id, role) VALUES (105, 'UNVERIFIED');

INSERT INTO usr(id, email, password, name, credentials_updated_at, version)
VALUES (106, 'blockeduser@example.com', '{bcrypt}$2a$10$nzg1V.oO8HIgtny2HaaJdObxwZIzz9HvbFP8nW0BfBID4COq8AZMe', 'Blocked User', '2000-01-01 12:01:01', 1);
